...
export const StatisticsRow: React.FC<StatisticsRowProps> = ({
  ...
  return (
    <section id="statistics" className="bg-white py-10 sm:py-12 border-y border-slate-100">
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        <div className="flex flex-col lg:flex-row lg:items-center">
          
          {/* LEFT COLUMN: ~40% Width - Hero Primary Metric (128 Sản phẩm đã nộp) */}
          <div className="w-full lg:w-[40%] lg:border-r lg:border-slate-200 lg:pr-8 xl:pr-12 pb-8 lg:pb-0 flex flex-col items-center justify-center text-center">
